...
public class AccessControlView implements FxmlView<AccessControlViewModel>, Initializable {
    ...
    @FXML private ListView<OicSecAce> amsListView;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        verticalResourcesList.getSelectionModel().getSelectedItems().addListener(new ListChangeListener<String>() {
            @Override
    ...
    private void processRetrieveAclResponse(ObservableValue<? extends Response<OicSecAcl>> observableValue, Response<OicSecAcl> oldValue, Response<OicSecAcl> newValue) {
    ...
    public void handleDeleteACL() {
        viewModel.deleteACL(viewModel.deviceProperty.get().getDeviceId(), amsListView.getSelectionModel().getSelectedItem().getAceID());
    }
