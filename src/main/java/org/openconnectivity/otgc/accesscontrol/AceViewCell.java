...
public class AceViewCell extends ListCell<OicSecAce> {
    ...
    @Override
    public void updateItem(OicSecAce ace, boolean empty) {
    ...
    private void addContent(OicSecAce ace) {
        setText(null);
        ...
        switch (ace.getSubject().getSubjectType()) {
            case SUBJECT_UUID:
                ...
                break;
            case SUBJECT_ROLE:
                subject.setText("Role ID: " + ace.getSubject().getRole().getId() +
                                ", Role Authority: " + ace.getSubject().getRole().getAuthority());
                break;
