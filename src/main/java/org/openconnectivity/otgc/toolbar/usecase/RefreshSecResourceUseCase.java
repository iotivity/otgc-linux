...
public class RefreshSecResourceUseCase {

    private final IotivityRepository iotivityRepository;

    @Inject
    public RefreshSecResourceUseCase(IotivityRepository iotivityRepository) {
        this.iotivityRepository = iotivityRepository;
    }

    public Single<Device> execute(String deviceId) {
        return iotivityRepository.findSingleDevice(deviceId, DeviceType.OWNED_BY_SELF);
    }
}
