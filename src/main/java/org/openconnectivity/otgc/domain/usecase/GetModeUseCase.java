...
public class GetModeUseCase {
    ...
    @Inject
    public GetModeUseCase(SettingRepository settingRepository) {
        this.settingRepository = settingRepository;
    }

    public Single<String> execute() {
        return Single.just(settingRepository.get(SettingRepository.MODE_KEY, SettingRepository.MODE_DEFAULT_VALUE));
    }
}
